...
public:
    ...
    fss_server(const fss_server &other) : flight_safety_system::client::fss_server(other), ca_file(other.ca_file), private_key_file(other.private_key_file), public_key_file(other.public_key_file) {};
