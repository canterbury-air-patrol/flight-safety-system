...
int main(int argc, char *argv[])
{
    ...
    while (running)
    {
        ...
        if (counter % 5 == 0)
        {
            ...
            auto msg_pos = new flight_safety_system::transport::fss_message_position_report(-43.5, 172.5, 300, 1800, 200, 0, 0, "example", 01200, 0, 1 | 2 | 4 | 8 | 16 | 32, 1, 14, flight_safety_system::fss_current_timestamp());
